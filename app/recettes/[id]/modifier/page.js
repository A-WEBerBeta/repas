...
export default function EditRecipePage() {
  ...
  function handleIngredientChange(rowId, selectedId) {
    const selectedIngredient = availableIngredients.find(
      (ingredient) => String(ingredient.id) === String(selectedId),
    );
          ...
          <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            <div className="w-full">
              ...
              <p className="mt-3 text-sm leading-6 text-muted">
                Mets à jour ta recette, ses ingrédients, ses portions ou sa
                préparation.
              </p>
            </div>
          ...
          >
            ...
            <div className="min-w-0 space-y-5">
              ...
              <div className="grid gap-5 xl:grid-cols-2 xl:items-stretch">
                ...
                <section className="rounded-3xl border border-white/7 bg-surface p-6 sm:p-7">
                  ...
                  <p className="mt-2 text-sm leading-6 text-muted">
                    Modifie le nom utilisé dans ton carnet et ton planning.
                  </p>
                  ...
                  <div className="mt-6">
                    ...
                    <input
                      ...
                      className={`mt-2 w-full border-b bg-transparent px-0 py-3 text-2xl text-app-text outline-none transition-colors ${
                        errors.name
                          ? "border-red-500/60"
                ...
                <section className="flex h-full flex-col rounded-3xl border border-white/7 bg-surface p-6 sm:p-7">
                  <div className="grid h-full gap-5 sm:grid-cols-[minmax(0,1fr)_220px] sm:items-center">
                    <div className="min-w-0">
                      ...
                      <p className="mt-2 text-sm leading-6 text-muted">
                        Facultatif — remplace ou supprime la photo actuelle.
                      </p>
                    </div>
              ...
              <section className="rounded-3xl border border-white/7 bg-surface p-6 sm:p-7">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-muted">
                      Modifie les ingrédients et leurs quantités de référence.
                    </p>
                ...
                {ingredients.length === 0 ? (
                  ...
                  >
                    <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-xl bg-peach/8 text-peach">
                      <Plus size={18} />
                    </div>
              ...
              <section className="rounded-3xl border border-white/7 bg-surface p-6 sm:p-7">
                ...
                <p className="mt-2 text-sm text-muted">
                  Facultatif — mets à jour les étapes de préparation.
                </p>
            ...
            <aside className="grid gap-4 sm:grid-cols-3 min-[2200px]:block min-[2200px]:space-y-4">
              ...
              <section className="rounded-3xl border border-white/7 bg-surface p-5 2xl:p-6">
                ...
                <p className="mt-2 text-sm leading-6 text-muted">
                  Enregistre tes changements pour mettre à jour cette recette.
                </p>
                ...
                <Link
                  href={`/recettes/${recipeId}`}
                  className="mt-2 block w-full rounded-xl px-4 py-2.5 text-center text-sm text-subtle transition-colors hover:bg-white/3 hover:text-app-text"
                >
                  Annuler
                </Link>
              </section>
